        ...
        <Column isSize={5} isOffset={1}>
          ...
          <div>
            <p css={{ marginBottom: '2em', marginRight: '1.5em' }}>
              BeautyCounter is lorem ipsum. The last time you had a cheeseburger
              was too long ago. Try not to drool when you think about the
              slightly charred, medium-rare meat nestled between soft brioche,
              cradled in crisp iceberg lettuce and flavour amplifying
              condiments.
            </p>
          </div>
        </Column>
